...
partidosFecha = np.array([
    [PAISES["Bolivia"],PAISES["Paraguay"]],
    [PAISES["Ecuador"],PAISES["Venezuela"]],
    [PAISES["Chile"],PAISES["Uruguay"]],
    [PAISES["Argentina"],PAISES["Colombia"]],
    [PAISES["Peru"],PAISES["Brasil"]]
    ]);
