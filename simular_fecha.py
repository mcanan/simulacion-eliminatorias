...
partidosFecha = np.array([
    [PAISES["Colombia"],PAISES["Bolivia"]],
    [PAISES["Uruguay"],PAISES["Brasil"]],
    [PAISES["Argentina"],PAISES["Chile"]],
    [PAISES["Venezuela"],PAISES["Peru"]],
    [PAISES["Paraguay"],PAISES["Ecuador"]]
    ]);
