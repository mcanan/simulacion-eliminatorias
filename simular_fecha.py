...
partidosFecha = np.array([
    [PAISES["Colombia"],PAISES["Chile"]],
    [PAISES["Uruguay"],PAISES["Ecuador"]],
    [PAISES["Paraguay"],PAISES["Peru"]],
    [PAISES["Venezuela"],PAISES["Bolivia"]],
    [PAISES["Brasil"],PAISES["Argentina"]]
    ]);
