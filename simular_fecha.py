...
partidosFecha = np.array([
    [PAISES["Bolivia"],PAISES["Argentina"]],
    [PAISES["Ecuador"],PAISES["Colombia"]],
    [PAISES["Chile"],PAISES["Venezuela"]],
    [PAISES["Brasil"],PAISES["Paraguay"]],
    [PAISES["Peru"],PAISES["Uruguay"]]
    ]);
