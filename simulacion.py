...
def getPartidosJugados():
    ...
    # Fecha 9
    partidos[PAISES["Ecuador"],PAISES["Chile"]]=[9,3,0]
    partidos[PAISES["Uruguay"],PAISES["Venezuela"]]=[9,3,0]
    partidos[PAISES["Paraguay"],PAISES["Colombia"]]=[9,0,1]
    ...
    # Fecha 11
    partidos[PAISES["Colombia"],PAISES["Chile"]]=[11,0,0]
    partidos[PAISES["Uruguay"],PAISES["Ecuador"]]=[11,2,1]
    partidos[PAISES["Paraguay"],PAISES["Peru"]]=[11,1,4]
    partidos[PAISES["Venezuela"],PAISES["Bolivia"]]=[11,5,0]
    partidos[PAISES["Brasil"],PAISES["Argentina"]]=[11,3,0]
    
    # Fecha 12
    partidos[PAISES["Bolivia"],PAISES["Paraguay"]]=[12,1,0]
    partidos[PAISES["Ecuador"],PAISES["Venezuela"]]=[12,3,0]
    partidos[PAISES["Chile"],PAISES["Uruguay"]]=[12,3,1]
    partidos[PAISES["Argentina"],PAISES["Colombia"]]=[12,3,0]
    partidos[PAISES["Peru"],PAISES["Brasil"]]=[12,0,2]

    # Fecha 13
    partidos[PAISES["Colombia"],PAISES["Bolivia"]]=[13,1,0]
    partidos[PAISES["Uruguay"],PAISES["Brasil"]]=[13,1,4]
    partidos[PAISES["Paraguay"],PAISES["Ecuador"]]=[13,2,1]
    partidos[PAISES["Venezuela"],PAISES["Peru"]]=[13,2,2]
    partidos[PAISES["Argentina"],PAISES["Chile"]]=[13,1,0]
    
    # Fecha 14
    partidos[PAISES["Bolivia"],PAISES["Argentina"]]=[14,2,0]
    partidos[PAISES["Ecuador"],PAISES["Colombia"]]=[14,0,2]
    partidos[PAISES["Chile"],PAISES["Venezuela"]]=[14,3,1]
    partidos[PAISES["Brasil"],PAISES["Paraguay"]]=[14,3,0]
    partidos[PAISES["Peru"],PAISES["Uruguay"]]=[14,2,1]
    
    # Fecha 15
    partidos[PAISES["Venezuela"],PAISES["Colombia"]]=[15,0,0]
    partidos[PAISES["Chile"],PAISES["Paraguay"]]=[15,0,3]
    partidos[PAISES["Uruguay"],PAISES["Argentina"]]=[15,0,0]
    partidos[PAISES["Brasil"],PAISES["Ecuador"]]=[15,2,0]
    partidos[PAISES["Peru"],PAISES["Bolivia"]]=[15,2,1]
    
    # Fecha 16
    partidos[PAISES["Bolivia"],PAISES["Chile"]]=[16,1,0]
    partidos[PAISES["Colombia"],PAISES["Brasil"]]=[16,1,1]
    partidos[PAISES["Ecuador"],PAISES["Peru"]]=[16,1,2]
    partidos[PAISES["Argentina"],PAISES["Venezuela"]]=[16,1,1]
    partidos[PAISES["Paraguay"],PAISES["Uruguay"]]=[16,1,2]
    
    # Fecha 17
    partidos[PAISES["Bolivia"],PAISES["Brasil"]]=[17,0,0]
    partidos[PAISES["Venezuela"],PAISES["Uruguay"]]=[17,0,0]
    partidos[PAISES["Chile"],PAISES["Ecuador"]]=[17,2,1]
    partidos[PAISES["Colombia"],PAISES["Paraguay"]]=[17,1,2]
    partidos[PAISES["Argentina"],PAISES["Peru"]]=[17,0,0]
    return partidos
